...
Bridge.assembly("TMS.UI", function ($asm, globals) {
    ...
    require(["canvasjs"], function (CanvasJS) {
                    ...
                    $asyncBody = Bridge.fn.bind(this, function () {
                        try {
                            for (;;) {
                                ...
                                switch ($step) {
                                    case 0: {
                                        new TMS.UI.Business.Dashboard.Dashboard().Render();
                                        new TMS.UI.Business.MenuComponent().Render();
                                        truck = new TMS.UI.Business.TruckManagement.AllTruck();
        ...
        Bridge.define("TMS.UI.Business.Dashboard.Dashboard", {
            ...
            methods: {
                ...
                ChartPanels: function () {
                    ...
                    TMS.UI.Business.Dashboard.Dashboard.Customers();
                    this.SaleAnalysis();
                ...
                ctor: function () {
                    ...
                    this.MenuItems = function (_o4) {
                            ...
                            _o4.add(($t = new TMS.UI.Business.MenuItem(), $t.ItemText = "Ng\u00e2n h\u00e0ng", $t.IconClass = "mif-library", $t.MenuItems = function (_o2) {
                                    var $t1;
                                    _o2.add(($t1 = new TMS.UI.Business.MenuItem(), $t1.ItemText = "Thu, chi ti\u1ec1n", $t1.IconClass = "fa fa-file-word", $t1));
                                    _o2.add(($t1 = new TMS.UI.Business.MenuItem(), $t1.ItemText = "Thu ti\u1ec1n g\u1edfi", $t1.IconClass = "fa fa-file-word", $t1));
                                    _o2.add(($t1 = new TMS.UI.Business.MenuItem(), $t1.ItemText = "Thu ti\u1ec1n kh\u00e1ch h\u00e0ng", $t1.IconClass = "fa fa-file-word", $t1));
                                    _o2.add(($t1 = new TMS.UI.Business.MenuItem(), $t1.ItemText = "\u0110\u1ed1i chi\u1ebfu ng\u00e2n h\u00e0ng", $t1.IconClass = "fa fa-file-word", $t1));
                                    return _o2;
                                }(new (System.Collections.Generic.List$1(TMS.UI.Business.MenuItem)).ctor()), $t));
                            _o4.add(($t = new TMS.UI.Business.MenuItem(), $t.ItemText = "Mua h\u00e0ng", $t.IconClass = "mif-add-shopping-cart", $t));
                            _o4.add(($t = new TMS.UI.Business.MenuItem(), $t.ItemText = "B\u00e1n h\u00e0ng", $t.IconClass = "mif-truck", $t));
                            _o4.add(($t = new TMS.UI.Business.MenuItem(), $t.ItemText = "H\u00f3a \u0111\u01a1n", $t.IconClass = "fa fa-file-invoice", $t));
                            _o4.add(($t = new TMS.UI.Business.MenuItem(), $t.ItemText = "Kho", $t.IconClass = "fa fa-warehouse", $t.MenuItems = function (_o3) {
                                    var $t1;
                                    _o3.add(($t1 = new TMS.UI.Business.MenuItem(), $t1.ItemText = "Nh\u1eadp xu\u1ea5t kho", $t1.IconClass = "fa fa-file-word", $t1));
                                    return _o3;
                                }(new (System.Collections.Generic.List$1(TMS.UI.Business.MenuItem)).ctor()), $t));
                            _o4.add(($t = new TMS.UI.Business.MenuItem(), $t.ItemText = "Settings", $t.IsGroup = true, $t));
                            _o4.add(($t = new TMS.UI.Business.MenuItem(), $t.ItemText = "Thi\u1ebft l\u1eadp", $t.IconClass = "mif-cogs", $t));
                            _o4.add(($t = new TMS.UI.Business.MenuItem(), $t.ItemText = "T\u00e0i kho\u1ea3n", $t.IconClass = "mif-user", $t));
                            _o4.add(($t = new TMS.UI.Business.MenuItem(), $t.IsDevider = true, $t));
                            _o4.add(($t = new TMS.UI.Business.MenuItem(), $t.ItemText = "\u0110\u0103ng xu\u1ea5t", $t.IconClass = "mif-exit", $t));
                            return _o4;
                        }(new (System.Collections.Generic.List$1(TMS.UI.Business.MenuItem)).ctor());
                }
            },
            methods: {
                Render: function () {
                ...
                RenderMenuItems: function (menuItems) {
                    MVVM.Html.Instance.Ul.ForEach$1(TMS.UI.Business.MenuItem, menuItems, Bridge.fn.bind(this, function (item, index) {
                        if (item.IsGroup) {
                            ...
                            MVVM.Html.Instance.Li.Anchor.Attr("data-role", "ripple").Event$3(TMS.UI.Business.MenuItem, "click", Bridge.fn.bind(this, function (menu, e) {
                                var $step = 0,
                                    $task1, 
                                    $jumpFromFinally, 
                                    $asyncBody = Bridge.fn.bind(this, function () {
        ...
        Bridge.define("TMS.UI.Business.MenuItem", {
            fields: {
                IsGroup: false,
                IsDevider: false,
                ItemText: null,
        ...
        Bridge.define("TMS.UI.Business.TruckManagement.AllTruck", {
            inherits: [Components.Component],
            fields: {
                Title: null,
                TruckId: 0,
            ...
            ctors: {
                init: function () {
                    this.Title = "Truck";
                    this.TruckHeader = new (MVVM.ObservableArray$1(Components.Header$1(TMS.API.Models.Truck))).ctor();
                    this.TruckData = new (MVVM.ObservableArray$1(TMS.API.Models.Truck)).ctor();
                                ...
                                for (;;) {
                                    ...
                                    switch ($step) {
                                        ...
                                        case 1: {
                                            ...
                                            trucks = $taskResult1;
                                            this.TruckData.Data$1 = ($t = TMS.API.Models.Truck, System.Linq.Enumerable.from(trucks, $t).ToArray($t));
                                            $tcs.setResult(null);
                                            return;
                                        }
                                        default: {
                                ...
                                for (;;) {
                                    ...
                                    switch ($step) {
                                        ...
                                        case 4: {
                                            ...
                                            oldTruck = System.Linq.Enumerable.from(this.TruckData.Data$1, TMS.API.Models.Truck).first(Bridge.fn.bind(this, function (x) {
