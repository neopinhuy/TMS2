 ...
 */
Bridge.assembly("LogContract", function ($asm, globals) {
    "use strict";
    ...
    Bridge.definei("LogContract.Interfaces.IRestful$1", function (T) { return {
        $kind: "interface"
    }; });

    Bridge.define("LogContract.Models.SaleLeaderBoardDataPoint", {
        fields: {
            gdp: 0,
            url: null
        }
    ...
    Bridge.define("LogContract.Interfaces.BaseClient$1", function (T) { return {
        inherits: [LogContract.Interfaces.IRestful$1(T)],
        fields: {
            BaseUrl: null
        },
        alias: [
            "GetList", "LogContract$Interfaces$IRestful$1$" + Bridge.getTypeAlias(T) + "$GetList",
            "Get", "LogContract$Interfaces$IRestful$1$" + Bridge.getTypeAlias(T) + "$Get",
            "PostAsync", "LogContract$Interfaces$IRestful$1$" + Bridge.getTypeAlias(T) + "$PostAsync",
            "PutAsync", "LogContract$Interfaces$IRestful$1$" + Bridge.getTypeAlias(T) + "$PutAsync",
            "Delete", "LogContract$Interfaces$IRestful$1$" + Bridge.getTypeAlias(T) + "$Delete"
        ],
        ctors: {
            ctor: function () {
                this.$initialize();
