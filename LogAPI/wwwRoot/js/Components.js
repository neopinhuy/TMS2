    ...
    Bridge.define("Components.Table$1", function (Data) { return {
        ...
        methods: {
            Render: function () {
                ...
                this.Headers.Subscribe$2(Bridge.fn.bind(this, function (x) {
                    this.Rerender(table);
                }));
                this.RowData.Subscribe$2(Bridge.fn.bind(this, function (x) {
                    this.Rerender(table);
                }));
            },
                            ...
                            for (;;) {
                                ...
                                switch ($step) {
                                    case 0: {
                                        ...
                                        $task1 = this.RenderTableContent(table);
                                        $step = 1;
                            ...
                            for (;;) {
                                ...
                                switch ($step) {
                                    case 0: {
                                        ...
                                        $task1 = System.Threading.Tasks.Task.whenAll(headerSources);
                                        $step = 1;
                                        if ($task1.isCompleted()) {
                                            continue;
                                        }
                                    ...
                                    case 1: {
                                        ...
                                        sources = Bridge.unbox(($taskResult1));

                                        html = MVVM.Html.Take(table);
                                        html.TBody.ForEach$1(Data, this.RowData.Data$1, Bridge.fn.bind(this, function (row, index) {
                                            html.TRow.ForEach$1(Components.Header$1(Data), this.Headers.Data$1, function (header, headerIndex) {
                                                ...
                                                if (!System.String.isNullOrEmpty(header.FieldName)) {
                                                    ...
                                                    if (header.Reference != null) {
                                                        var source = ($t1 = System.Linq.Enumerable.from(sources, System.Collections.Generic.IEnumerable$1(System.Object)).firstOrDefault(function (x) {
