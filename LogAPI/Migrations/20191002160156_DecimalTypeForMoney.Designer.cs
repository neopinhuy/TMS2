...
namespace LogAPI.Migrations
{
    ...
    [Migration("20191002160156_DecimalTypeForMoney")]
    partial class DecimalTypeForMoney
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LogAPI.Models.ContainerMaintenance", b =>
                {
                    ...
                    b.Property<decimal>("AdvancedPaid")
                        .HasColumnType("decimal(20, 5)");
            ...
            modelBuilder.Entity("LogAPI.Models.CommodityType", b =>
                {
                    b.HasOne("LogAPI.Models.User", "UserInserted")
                        .WithMany("CommodityTypeInsertedBy")
                        .HasForeignKey("InsertedBy")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("LogAPI.Models.User", "UserUpdated")
                        .WithMany("CommodityTypeUpdatedBy")
                        .HasForeignKey("UpdatedBy");
                });
            ...
            modelBuilder.Entity("LogAPI.Models.Container", b =>
                {
                    ...
                    b.HasOne("LogAPI.Models.User", "UserInserted")
                        .WithMany("ContainerInsertedBy")
                        .HasForeignKey("InsertedBy")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("LogAPI.Models.User", "UserUpdated")
                        .WithMany("ContainerUpdatedBy")
                        .HasForeignKey("UpdatedBy");
            ...
            modelBuilder.Entity("LogAPI.Models.ContainerMonitorConfig", b =>
                {
                    ...
                    b.HasOne("LogAPI.Models.User", "UserInserted")
                        .WithMany("ContainerMonitorConfigInsertedBy")
                        .HasForeignKey("InsertedBy")
                        .OnDelete(DeleteBehavior.Cascade);
                    ...
                    b.HasOne("LogAPI.Models.User", "UserUpdated")
                        .WithMany("ContainerMonitorConfigUpdatedBy")
                        .HasForeignKey("UpdatedBy");
                });
            ...
            modelBuilder.Entity("LogAPI.Models.ContainerType", b =>
                {
                    b.HasOne("LogAPI.Models.User", "UserInserted")
                        .WithMany("ContainerTypeInsertedBy")
                        .HasForeignKey("InsertedBy")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("LogAPI.Models.User", "UserUpdated")
                        .WithMany("ContainerTypeUpdatedBy")
                        .HasForeignKey("UpdatedBy");
                });
            ...
            modelBuilder.Entity("LogAPI.Models.Contract", b =>
                {
                    b.HasOne("LogAPI.Models.User", "UserInserted")
                        .WithMany("ContractInsertedBy")
                        .HasForeignKey("InsertedBy")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("LogAPI.Models.User", "UserUpdated")
                        .WithMany("ContractUpdatedBy")
                        .HasForeignKey("UpdatedBy");
            ...
            modelBuilder.Entity("LogAPI.Models.Coordination", b =>
                {
                    ...
                    b.HasOne("LogAPI.Models.User", "UserInserted")
                        .WithMany("CoordinationInsertedBy")
                        .HasForeignKey("InsertedBy")
                        .OnDelete(DeleteBehavior.Cascade);
                    ...
                    b.HasOne("LogAPI.Models.User", "UserUpdated")
                        .WithMany("CoordinationUpdatedBy")
                        .HasForeignKey("UpdatedBy");
                });
            ...
            modelBuilder.Entity("LogAPI.Models.Department", b =>
                {
                    b.HasOne("LogAPI.Models.User", "UserInserted")
                        .WithMany("DepartmentInsertedBy")
                        .HasForeignKey("InsertedBy")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("LogAPI.Models.User", "Leader")
                        .WithMany("DepartmentLeader")
                        .HasForeignKey("LeaderId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("LogAPI.Models.User", "UserUpdated")
                        .WithMany("DepartmentUpdatedBy")
                        .HasForeignKey("UpdatedBy");
                });
            ...
            modelBuilder.Entity("LogAPI.Models.FreightBalance", b =>
                {
                    ...
                    b.HasOne("LogAPI.Models.User", "UserUpdated")
                        .WithMany("FreightBalanceUpdatedBy")
                        .HasForeignKey("UpdatedBy");
                });
            ...
            modelBuilder.Entity("LogAPI.Models.FreightHistory", b =>
                {
                    ...
                    b.HasOne("LogAPI.Models.User", "UserInserted")
                        .WithMany("FreightHistoryInsertedBy")
                        .HasForeignKey("InsertedBy")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("LogAPI.Models.User", "UserUpdated")
                        .WithMany("FreightHistoryUpdatedBy")
                        .HasForeignKey("UpdatedBy");
                });
            ...
            modelBuilder.Entity("LogAPI.Models.FreightProof", b =>
                {
                    ...
                    b.HasOne("LogAPI.Models.User", "UserInserted")
                        .WithMany("FreightProofInsertedBy")
                        .HasForeignKey("InsertedBy")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("LogAPI.Models.User", "UserUpdated")
                        .WithMany("FreightProofUpdatedBy")
                        .HasForeignKey("UpdatedBy");
                });
            ...
            modelBuilder.Entity("LogAPI.Models.FreightState", b =>
                {
                    b.HasOne("LogAPI.Models.User", "UserInserted")
                        .WithMany("FreightStateInsertedBy")
                        .HasForeignKey("InsertedBy")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("LogAPI.Models.User", "UserUpdated")
                        .WithMany("FreightStateUpdatedBy")
                        .HasForeignKey("UpdatedBy");
                });
            ...
            modelBuilder.Entity("LogAPI.Models.GroupRole", b =>
                {
                    b.HasOne("LogAPI.Models.User", "UserInserted")
                        .WithMany("GroupRoleInsertedBy")
                        .HasForeignKey("InsertedBy")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("LogAPI.Models.User", "UserUpdated")
                        .WithMany("GroupRoleUpdatedBy")
                        .HasForeignKey("UpdatedBy");
                });
            ...
            modelBuilder.Entity("LogAPI.Models.MaintenanceTicket", b =>
                {
                    ...
                    b.HasOne("LogAPI.Models.User", "Assignee")
                        .WithMany("MaintenanceTicketAssignee")
                        .HasForeignKey("AssigneeId");
                    ...
                    b.HasOne("LogAPI.Models.User", "UserInserted")
                        .WithMany("MaintenanceTicketInsertedBy")
                        .HasForeignKey("InsertedBy")
                        .OnDelete(DeleteBehavior.Cascade);
                    ...
                    b.HasOne("LogAPI.Models.User", "UserUpdated")
                        .WithMany("MaintenanceTicketUpdatedBy")
                        .HasForeignKey("UpdatedBy");
                });
            ...
            modelBuilder.Entity("LogAPI.Models.PaymentApprovalConfig", b =>
                {
                    ...
                    b.HasOne("LogAPI.Models.User", "UserInserted")
                        .WithMany("PaymentApprovalConfigInsertedBy")
                        .HasForeignKey("InsertedBy")
                        .OnDelete(DeleteBehavior.Cascade);
                    ...
                    b.HasOne("LogAPI.Models.User", "UserUpdated")
                        .WithMany("PaymentApprovalConfigUpdated")
                        .HasForeignKey("UpdatedBy");
            ...
            modelBuilder.Entity("LogAPI.Models.User", b =>
                {
                    b.HasOne("LogAPI.Models.Department", "Department")
                        .WithMany("UserInDepartment")
                    ...
                    b.HasOne("LogAPI.Models.User", "Supervisor")
                        .WithMany("Reporter")
